...
public class AdministratorController {
	...
	public String updatePrice(@RequestParam Map<String, Object> params) {
		...
		log.debug("[컨트롤러]업데이트할 가격 : " + params.get("updatePrice"));
	...
	public String addProduct(@RequestParam Map<String, Object> params) {
		log.debug("[컨트롤러]추가할 상품 이름 : " + params.get("productName"));
		log.debug("[컨트롤러]추가할 상품 가격 : " + params.get("productPrice"));
	...
	public String delProduct(@RequestParam Map<String, Object> params) {
		log.debug("[컨트롤러]제거할 상품 번호 : " + params.get("productKey"));
		log.debug("[컨트롤러]제거할 상품 이름 : " + params.get("productName"));
	...
	public String addCashStock(@RequestParam Map<String, Object> params) {
		log.debug("[컨트롤러]재고추가할 화폐번호 : " + params.get("cashKey"));
		log.debug("[컨트롤러]재고추가할 화폐단위 : " + params.get("cashType"));
		log.debug("[컨트롤러]몇개를 추가할지 : " + params.get("addCashStock"));
	...
	public String addStock(@RequestParam Map<String, Object> params) {
		log.debug("[컨트롤러]제품키 디버깅 : " + params.get("productKey"));
		log.debug("[컨트롤러]추가할 재고 갯수 디버깅 : " + params.get("addStock"));
